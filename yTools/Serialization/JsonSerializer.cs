...
namespace yTools.Serialization
{
    public class JsonSerializer
    {
        ...
        /// <summary>
        /// Serializes the given object of type T into the given file path in a JSON format.<br/>
        ...
        /// <summary>
        /// Serializes the given object of type T into the given file name and parent directory in JSON format.<br/>

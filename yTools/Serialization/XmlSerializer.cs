...
namespace yTools.Serialization
{
    public class XmlSerializer
    {
        ...
        /// <summary>
        /// Serializes the given object of type T into the given file path in XML format.<br/>
        ...
        /// <summary>
        /// Serializes the given object of type T into the given file name and parent directory in XML format.<br/>
